...
export function LandingPage() {
  return (
    ...
    <div
      className="flex h-full flex-grow flex-col justify-center items-center text-center text-neutral-200 pt-14"
      style={{ backgroundColor: "black" }}
    >
      {/* Use a single paragraph element for the main heading */}
      <p
        className="font-semibold text-4xl text-center items-center flex flex-col pt-2"
        style={{ color: "yellow" }}
      >
        Welcome To
      ...
      <p className="text-sm p-4" style={{ color: "yellow" }}>
